...
$pdf->SetHeaderData('logo.png', 16, 'Lista de Funcionarios', 'Instituto Nacional de Comunicação e Imagem de Moçambique');
...
if(count($data)>0)
{
$header = array('','Codigo', 'Nome do Funcionario');
// print colored table
		...
		//var_dump($row);
			$pdf->Cell($w[0], 6, $row[1], 'LR', 0, 'C', $fill);
			$pdf->Cell($w[1], 6, $row[2], 'LR', 0, 'C', $fill);
