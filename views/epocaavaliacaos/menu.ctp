...
<div class="actions" id="left-column">
	...
	<br />
<?php echo $this->Html->link(sprintf(__('Avaliacao', true)), array('controller' => 't0016avaliacaos','action' => 'index'),array('class'=>'link')); ?>
...
<?php echo $this->Html->link(sprintf(__('Épocas de Avaliação', true)), array('controller' => 't0014epocaavaliacaos', 'action' => 'index'),array('class'=>'linkselected')); ?>
