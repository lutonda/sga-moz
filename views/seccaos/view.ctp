...
<h2><?php  __('Seccao');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Faculdade'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
...
<div class="related">
	<h3><?php __('Related Docentes');?></h3>
	<?php if (!empty($seccao['Docente'])):?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php __('Id'); ?></th>
		<th><?php __('Entidade Id'); ?></th>
		<th><?php __('Seccao Id'); ?></th>
		<th><?php __('Docente Categoria Id'); ?></th>
