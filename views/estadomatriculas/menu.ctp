...
<div class="actions" id="left-column">
	...
	<?php  echo $this->Html->link(sprintf(__('Tipos de Movimento', true)), array('controller' => 'tg0015tipomovimentos'),array('class'=>'link')); ?>
        ...
        <?php  echo $this->Html->link(sprintf(__('Estados das Inscrições', true)), array('controller' => 'tg0020estadoinscricaos'),array('class'=>'link')); ?>
        <?php  echo $this->Html->link(sprintf(__('Estados das Matriculas', true)), array('controller' => 'tg0021estadomatriculas'),array('class'=>'linkselected')); ?>
        <?php  echo $this->Html->link(sprintf(__('Géneros', true)), array('controller' => 'tg0019generos'),array('class'=>'link')); ?>
