	...
	<tr<?php echo $class;?>>
		...
		<td class="accoes">
	            <?php echo $html->image("/img/login-icon.gif", array("alt" => "Brownies","title"=>"Visualizar",'url' => array('action' => 'view', $genero['Genero']['id']))); ?>
                    <?php echo $html->image("/img/edit-icon.gif", array("alt" => "Brownies","title"=>"Editar",'url' => array('action' => 'edit',$genero['Genero']['id']))); ?>
                    <?php echo $html->image("/img/hr.gif", array("alt" => "Brownies","title"=>"Eliminar",'url' => array('action' => 'delete', $genero['Genero']['id']), null, sprintf(__('Tem a certeza que deseja eliminar # %s?', true),$genero['Genero']['id']))); ?>
		</td>
