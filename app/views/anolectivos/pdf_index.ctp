...
$pdf->SetTitle('Lista de Anos Lectivos');
$pdf->SetSubject('TCPDF Tutorial');
// set default header data
$pdf->SetHeaderData('logo.png', 16, 'Lista de Anos Lectivos', "Instituto Superior de Comunicação e Imagem de Moçambique");
...
//Column titles
$header = array('ID', 'Código', 'Ano', 'Nr de Semestres');
