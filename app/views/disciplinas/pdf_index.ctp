...
$pdf->SetTitle('Lista de Disciplinas');
$pdf->SetSubject('TCPDF Tutorial');
// set default header data
$pdf->SetHeaderData('logo.png', 16, 'Lista de Disciplinas', "Instituto Nacional de Comunicação e Imagem de Moçambique");
...
//Column titles
$header = array('ID', 'Codigo','Disciplina','Grupo Disciplinar');
