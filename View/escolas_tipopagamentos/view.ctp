...
<h2><?php  __('Escolas Tipopagamento');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Escola'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Tipopagamento'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Data Limite'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $escolasTipopagamento['EscolasTipopagamento']['data_limite']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Mes Limite'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $escolasTipopagamento['EscolasTipopagamento']['mes_limite']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Dia Limite'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
