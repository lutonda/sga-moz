...
<div class="projectos form" id="center-column">
      <div class="top-bar">
        <?php echo $this->Html->link(sprintf(__('Lista de Area de Trabalho', true)), array('action' => 'index'),array('class'=>'button')); ?>
	<h1><?php echo __('Area de Trabalho - adicionar');?></h1>

    </div>
    <div class="table">


<?php echo $this->Form->create('Areatrabalho');?>
