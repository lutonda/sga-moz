...
<div class="projectos index" id="center-column">
	...
	<tr<?php echo $class;?>>
		...
		<td class="accoes">
	            <?php echo $this->Html->image("/img/login-icon.gif", array("alt" => "Brownies","title"=>"Visualizar",'url' => array('action' => 'view',$tg0010areatrabalho['Tg0010areatrabalho']['id']))); ?>
                    <?php echo $this->Html->image("/img/edit-icon.gif", array("alt" => "Brownies","title"=>"Editar",'url' => array('action' => 'edit',$tg0010areatrabalho['Tg0010areatrabalho']['id']))); ?>
					<?php echo $this->Html->image("/img/hr.gif", array("alt" => "Brownies","title"=>"Eliminar",'url' => array('action' => 'delete', $tg0010areatrabalho['Tg0010areatrabalho']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $tg0010areatrabalho['Tg0010areatrabalho']['id']))); ?>
		</td>
