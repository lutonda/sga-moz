...
<div class="box box-100 altbox" id="box1"><!-- box full-width -->
	...
	<?php
	$i = 0;
	foreach ($epocaavaliacaos as $epocaavaliacao):
		$class = null;
		if ($i++ % 2 == 0) {
			$class = ' class="altrow"';
		}
	...
	<tr<?php echo $class;?>>
		<td class="tc first"><input type="checkbox" value="true" name="data-1-check-all" id="data-1-check-all"></td>
		<td><?php echo $epocaavaliacao['Epocaavaliacao']['id']; ?>&nbsp;</td>
		<td><?php echo $epocaavaliacao['Epocaavaliacao']['name']; ?>&nbsp;</td>
		

		<td class="accoes">
	            <?php echo $this->Html->image("/img/login-icon.gif", array("alt" => "Brownies","title"=>"Visualizar",'url' => array('action' => 'view', $epocaavaliacao['Epocaavaliacao']['id']))); ?>
                    <?php if($grupo ==1) echo $this->Html->image("/img/edit-icon.gif", array("alt" => "Brownies","title"=>"Editar",'url' => array('action' => 'edit', $epocaavaliacao['Epocaavaliacao']['id']))); ?>
                    <?php if($grupo ==1) echo $this->Html->image("/img/hr.gif", array("alt" => "Brownies","title"=>"Remover",'url' => array('action' => 'delete', $epocaavaliacao['Epocaavaliacao']['id']), null, sprintf(__('Tem a certeza que deseja eliminar # %s?', true),$epocaavaliacao['Epocaavaliacao']['id']))); ?>
		</td>
