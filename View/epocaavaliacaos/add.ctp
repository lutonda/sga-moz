 ...
 */
 ...
 <div  class="box box-100">
	<div class="boxin">
		<div class="header">
			<h3><?php echo __('Adicionar Época de Avaliação')?></h3>
			<a href="#" class="button"><?php echo __('Lista de Épocas de Avaliação')?>&nbsp;»</a>
		</div>
		<?php echo $this->Form->create('Epocaavaliacao',array('class'=>'fields'));?>
		<fieldset>
			<legend><?php echo __('Detalhes da Época de Avaliação')?></legend>
			<table>
				<tr>
				<td width="50%">
					<table>
