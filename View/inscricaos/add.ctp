<?php $this->Html->addCrumb('Manutenção', '/t0009anolectivos'); ?>
<?php $this->Html->addCrumb('Inscrições', '/t0013inscricaos'); ?>
<?php $this->Html->addCrumb('Nova Inscrição', '/t0013inscricaos/add'); ?>
...
<div class="projectos form" id="center-column">
	...
	<h1><?php echo __('Nova Inscrição');?></h1>
...
<?php echo $this->Form->create('T0013inscricao');?>
	...
	<?php 
		...
		echo $this->Form->input('turno_id',array('disabled'=>'true','value'=>$turno,'label'=>'Turno da Turma','before'=>'<tr><td>','between'=>'</td><td>','after'=>'</td></tr>','div'=>false,'id'=>'turno'));
