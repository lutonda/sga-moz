...
<div class="projectos form" id="center-column">
	...
	<h1><?php echo __('Editar Inscricao');?></h1>
    ...
    echo $this->Form->create('Inscricao');?>
	  ...
	  <?php	
		...
		echo $this->Form->input('tf',array('disabled'=>'true','value'=>$docente1,'label'=>'Docente','before'=>'<tr><td>','between'=>'</td><td>','after'=>'</td></tr>','div'=>false,'id'=>'cursoid'));	
			...
			echo $this->Form->input('tg0020estadoinscricao_id',array('options'=>$estadoinscricao,'label'=>'Estado','before'=>'<tr><td>','between'=>'</td><td>','after'=>'</td></tr>','div'=>false,'id'=>'cursoid'));	

			echo $this->Form->input('notafrequencia',array('options'=>$notafrequencia,'label'=>'Nota de Frequencia do Aluno ','before'=>'<tr><td>','between'=>'</td><td>','after'=>'</td></tr>','div'=>false,'id'=>'cursoid'));	
