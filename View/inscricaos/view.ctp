...
<div class="projectos form" id="center-column">
	...
	<h1><?php echo __('Visualizar Inscricao');?></h1>
...
<?php	
		...
		echo $this->Form->input('tf',array('disabled'=>'true','value'=>$docente1,'label'=>'Docente','before'=>'<tr><td>','between'=>'</td><td>','after'=>'</td></tr>','div'=>false,'id'=>'cursoid'));	
			...
			echo $this->Form->input('epocaavaliacao_id',array('disabled'=>'true','options'=>$epocaavaliacao_id ,'label'=>'Epoca da Avaliacao','before'=>'<tr><td>','between'=>'</td><td>','after'=>'</td></tr>','div'=>false,'id'=>'cursoid'));				
