...
<div class="box box-100 altbox" id="box1"><!-- box full-width -->
					<div class="boxin">
						<div class="header">
							<h3><?php echo __('Planos de estudos')?></h3>
			...
			<th><?php echo $this->Paginator->sort('Semestre','semestresano');?></th>
            								...
            								<td><?php echo $this->Form->input('curso_id',array('label'=>false,'empty'=>true)); ?></td>
	...
	<tr <?php echo $class;?>>
		...
		<td class="accoes">
	            ...
	            <?php echo $this->Html->link($this->Html->image("/img/save-icon.gif"),  array('action' => 'pdf_index_planoestudo',$planoestudo['Planoestudo']['id']),array('target'=>'_blank','escape'=>false)); ?></td>
