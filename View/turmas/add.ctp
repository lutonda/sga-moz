					...
					<td width="49%">
							...
							<tr>
								<td>
									...
									<span class="input_wrapper blank">
										<?php echo $this->Form->input('anocurricular',array('label'=>false,'div'=>false,'class'=>'txt','size'=>45));?>
									</span>
								</td>
							</tr>
							<tr>
								<td>
									...
									<span class="input_wrapper blank">
										<?php  echo $this->Form->input('semestrecurricular',array('label'=>false,'div'=>false));?>
									<span class="input_wrapper blank">
								</td>
							</tr>
							<tr>
