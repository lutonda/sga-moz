...
<div class="top-bar">
	...
	<h1><?php echo __('Turma - Editar');?></h1>
...
<div class="table">
	...
	<table class="listingform" cellpadding="0" cellspacing="0">
		...
		<?php
			...
			echo $this->Form->input($disciplina['Disciplina']['id'].'.Turma.nummaximo.',array('label'=>'Num. Maximo de Alunos','before'=>'<tr><td>','between'=>'</td><td>','after'=>'</td></tr>','div'=>false,'id'=>'cursoid'));
			
			echo $this->Form->input('funcionario_id',array('options'=>$funcionarios,'label'=>'Docente','before'=>'<tr><td>','between'=>'</td><td>','after'=>'</td></tr>','div'=>false,'id'=>'cursoid'));	

			echo $this->Form->input('funcionario_ass_id',array('options'=>$funcionarios,'label'=>'Assistente','before'=>'<tr><td>','between'=>'</td><td>','after'=>'</td></tr>','div'=>false,'id'=>'cursoid'));
			
			echo $this->Form->input('estado',array('options'=>$estado,'label'=>'Estado','before'=>'<tr><td>','between'=>'</td><td>','after'=>'</td></tr>','div'=>false,'id'=>'cursoid'));
