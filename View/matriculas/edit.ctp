...
<?php
	...
	<th class="full" colspan="2">Dados da Matricula</th>
        <?php
        echo $this->Form->input('Aluno_id',array('disabled'=>'true','label'=>'Estudante','before'=>'<tr><td>','between'=>'</td><td>','after'=>'</td></tr>','div'=>false));
        echo $this->Form->input('t0003curso_id',array('disabled'=>'true','label'=>'Curso','before'=>'<tr><td>','between'=>'</td><td>','after'=>'</td></tr>','div'=>false));
