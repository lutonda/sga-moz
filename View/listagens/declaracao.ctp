<div class="actions" id="left-column">
	...
	<?php echo $this->Html->link(sprintf(__('Listagem de Estudantes', true)), array('action' => 'listagens'),array('class'=>'link')); ?>
		...
		<?php echo $this->Html->link(sprintf(__('Declaracao',  true)), array('action' => 'declaracao'),array('class'=>'linkselected'));?>
...
<div class="projectos index" id="center-column">
	...
	<h1><?php echo __('Declaracao de Frequencias');?></h1>
	...
	<tr>
        <td>
        <?php echo $this->Form->create('Listagens',array('action' => 'print_pdf_declaracao_frequencia','target'=>'_blank'));?>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <?php
            ...
            <?php
            echo $this->Form->input('name',array('options'=>$t000alunos,'type'=>'select','div'=>false,'label'=>false));
	    ?>
            <?php
            ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </td>
