<div class="actions" id="left-column">
	...
	<?php echo $this->Html->link(sprintf(__('Listagem de Estudantes', true)), array('action' => 'listagens'),array('class'=>'link')); ?>
        ...
        <?php echo $this->Html->link(sprintf(__('Alunos Inscritos',  true)), array('action' => 'inscricao'),array('class'=>'link'));?>
         <?php echo $this->Html->link(sprintf(__('Mapa de Frequencias',  true)), array('action' => 'listagem_de_pautas'),array('class'=>'link'));?>
		 <?php echo $this->Html->link(sprintf(__('Pauta de Resultados',  true)), array('action' => 'listagem_de_pauta_resultados'),array('class'=>'linkselected'));?>
...
<div class="projectos index" id="center-column">
	...
	<h1><?php echo __('Listagens da Pauta de Resultados');?></h1>
	...
	<tr>
        <td>
        <?php echo $this->Form->create('Listagens',array('action' => 'print_pdf_pauta_de_resultados','target'=>'_blank'));?>
      
                <?php
          // $options= array('1'=>'Masculino','2'=>'Femenino');
            $options= array('1'=>'Turma');
	    ...
	    echo $this->Form->radio('select',$options,$attributes,array('size'=>15));?>
            <?php
            ?>&nbsp;&nbsp;<?php
            echo $this->Form->input('turma',array('options'=> $turma,'type'=>'select','div'=>false,'label'=>false));?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <?php // echo $this->Form->label('name','Curso',array('size'=>'65'));?>
           <?php // echo $this->Form->input('t0003curso_id',array('type'=>'select','div'=>false,'label'=>false));
        ?>
