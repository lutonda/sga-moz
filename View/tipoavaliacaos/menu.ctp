...
<div class="actions" id="left-column">
	...
	<br />
<?php echo $this->Html->link(sprintf(__('Avaliacao', true)), array('controller' => 'avaliacaos','action' => 'registo_de_notas'),array('class'=>'link')); ?>
<?php echo $this->Html->link(sprintf(__('Tipo de Avaliacoes', true)), array('controller' => 'tipoavaliacaos', 'action' => 'index'),array('class'=>'linkselected')); ?>
